 ...
 *
 * The file holds the keys of the local databases and keystores. Rewriting it in place could leave
 * a truncated file after a crash, and with it data that can no longer be decrypted.
 */
