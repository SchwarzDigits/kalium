...
// Apple builds without AVS (`kalium.disableAppleAvs`): AVS is reported as unavailable, and nothing calls into it.

actual object AppleAvs {
    actual val bridge: AppleAvsBridge = UnavailableAppleAvsBridge
}
...
private object UnavailableAppleAvsBridge : AppleAvsBridge {
    ...
    override fun setNetworkQualityInterval(handle: UInt, callbacks: AppleAvsCallbacks, intervalInSeconds: Int) = Unit
